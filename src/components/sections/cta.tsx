    ...
    <section className="py-24">
      <div className="max-w-4xl mx-auto px-4 text-center flex flex-col items-center">
        ...
        <ShimmerButton className="shadow-2xl h-24 px-16">
          <span className="whitespace-pre-wrap text-center text-2xl font-bold leading-none tracking-tight text-white dark:from-white dark:to-slate-900/10 lg:text-4xl">
            Book a Call
          </span>
        </ShimmerButton>
      </div>
