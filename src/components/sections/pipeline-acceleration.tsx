      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-neutral-900 mb-6">
            Massively Accelerate your{" "}
            <Highlight className="text-black">Outbound Pipelines</Highlight>{" "}
            With HODHOD
          </h2>
          <p className="text-xl text-neutral-600">
            Increase your total sales by 7% to 15% by accelerating your outbound
            pipelines with HODHOD.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {automationFeatures.map((feature, idx) => (
            <Card
              key={idx}
              className="border-neutral-200 bg-white/50 backdrop-blur-sm hover:shadow-lg transition-shadow"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <p className="text-lg text-neutral-600 mb-8">
              Manual outreach is slow and inconsistent. HODHOD automates the
              heavy lifting while maintaining the quality of a human expert.
            </p>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl opacity-5 blur-lg" />
            <div className="relative bg-white border border-neutral-200 rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                <div className="bg-neutral-50 p-4 rounded-lg text-sm text-neutral-600">
                  <span className="font-semibold block text-neutral-900 mb-1">
                    Observation:
                  </span>
                  Prospect recently posted about scaling engineering teams and
                  is hiring for 2 senior roles.
                </div>
                <div className="bg-neutral-50 p-4 rounded-lg text-sm text-neutral-600">
                  <span className="font-semibold block text-neutral-900 mb-1">
                    Generated Message Strategy:
                  </span>
                  Reference their recent post, mention our solution for scaling
                  teams efficiently, and offer a specific case study.
                </div>
          ...
          <div className="relative z-10">
            <div className="max-w-3xl mb-12">
              ...
              <p className="text-neutral-300 text-lg">
                Hodhod is like having a sales rep who recognizes, learns about,
                and reaches out with custom 1-to-1 marketing for every visitor
                of your business.
              </p>
            </div>
            ...
            <div className="mt-12 p-6 bg-indigo-900/30 border border-indigo-500/30 rounded-xl max-w-2xl">
              <h4 className="text-lg font-bold text-indigo-300 mb-2">
                HODHOD AI Remarketing
              </h4>
              <p className="text-neutral-300">
                HODHOD uses all this data to create 1-to-1 custom remarketing
                that is endlessly scalable. Not just scraping — we build a
                relationship.
              </p>
            </div>
          </div>
